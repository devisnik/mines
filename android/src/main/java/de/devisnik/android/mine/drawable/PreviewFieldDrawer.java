...
public class PreviewFieldDrawer extends CachingDrawer {
	...
	public PreviewFieldDrawer(final StyleColorProvider colorProvider, final Typeface face) {
		super(10, 10);
	...
	private void initDrawables(final Typeface face) {
		...
		// register(12, createLayer(button, flag, new
		// CrossDrawable(getColor(ColorId.ERROR))));
		// register(13, createLayer(new ColorDrawable(getColor(ColorId.ERROR)),
		// bomb));
		register(14, focus);
		register(15, touched);
	}
	...
	public void setSize(final int buttonSize) {
		super.setSize(buttonSize, buttonSize);
	}
